...
<div id="dataDivID" class="form-container" style="display:none;">
    ...
    $conn = imap_open('{'.$domainURL.':143/notls}Sent',$emailAddress,$emailPassword) or die('Cannot connect to domain:' . imap_last_error());
    ...
    echo('<p>You have '.$nMsgCount.' messages.</p>');
