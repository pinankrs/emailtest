...
<div id="dataDivID" class="form-container" style="display:none;">
    ...
    $conn = imap_open('{' . $domainURL . ':143/notls}Personal', $emailAddress, $emailPassword) or die('Cannot connect to domain:' . imap_last_error());
    ...
    // $ountmails = imap_search($conn1, 'ALL');
